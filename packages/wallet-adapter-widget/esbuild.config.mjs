...
const formats = {
  esm: {
    ...
    splitting: true,
    packages: 'external',
    external: ['crypto', 'buffer', 'util', 'near-api-js'] // Mark these as external
  },
  cjs: {
    outdir: './dist/cjs',
    tsconfig: 'tsconfig.cjs.json',
    format: 'cjs',
    platform: 'node', // Node.js platform for CJS
    entryPoints: allEntryPoints,
    bundle: true,
    packages: 'external',
    external: ['crypto', 'buffer', 'util', 'near-api-js'] // Mark these as external
  ...
  umd: {
    ...
    tsconfig: 'tsconfig.cjs.json',
    format: 'iife',
    platform: 'browser', // Browser platform for UMD
    globalName,
...
const commonOptions = {
  ...
  logLevel: 'info',
  banner: {
    js: '/* ⋈ 🏃🏻💨 FastNEAR Wallet Adapter Widget - https://github.com/fastnear */'
  },
  plugins: [{
  ...
  // Note: these are added because of here-wallet and external packages
  external: ["bn.js", "near-api-js", "borsh"],
}
